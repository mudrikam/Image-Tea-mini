...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDefault_Prompt = QAction(MainWindow)
        self.actionDefault_Prompt.setObjectName(u"actionDefault_Prompt")
        self.actionCustom_Prompt = QAction(MainWindow)
        self.actionCustom_Prompt.setObjectName(u"actionCustom_Prompt")
        self.actionNegative_Prompt = QAction(MainWindow)
        self.actionNegative_Prompt.setObjectName(u"actionNegative_Prompt")
        self.actionMetadata_Prompt_2 = QAction(MainWindow)
        self.actionMetadata_Prompt_2.setObjectName(u"actionMetadata_Prompt_2")
        self.actionPrompt_Preferences = QAction(MainWindow)
        self.actionPrompt_Preferences.setObjectName(u"actionPrompt_Preferences")
        ...
        self.menuPrompt = QMenu(self.menubar)
        self.menuPrompt.setObjectName(u"menuPrompt")
...
"}")
        ...
        self.menubar.addAction(self.menuPrompt.menuAction())
        ...
        self.menuPrompt.addAction(self.actionDefault_Prompt)
        self.menuPrompt.addAction(self.actionCustom_Prompt)
        self.menuPrompt.addAction(self.actionNegative_Prompt)
        self.menuPrompt.addAction(self.actionMetadata_Prompt_2)
        self.menuPrompt.addSeparator()
        self.menuPrompt.addAction(self.actionPrompt_Preferences)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDefault_Prompt.setText(QCoreApplication.translate("MainWindow", u"Default Prompt", None))
        self.actionCustom_Prompt.setText(QCoreApplication.translate("MainWindow", u"Custom Prompt", None))
        self.actionNegative_Prompt.setText(QCoreApplication.translate("MainWindow", u"Negative Prompt", None))
        self.actionMetadata_Prompt_2.setText(QCoreApplication.translate("MainWindow", u"Metadata Prompt", None))
        self.actionPrompt_Preferences.setText(QCoreApplication.translate("MainWindow", u"Prompt Preferences", None))
        ...
        self.menuPrompt.setTitle(QCoreApplication.translate("MainWindow", u"Prompt", None))
    # retranslateUi
